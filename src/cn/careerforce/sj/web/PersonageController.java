...
public class PersonageController {
    ...
    public Map<String, Object> queryPersonByIdMain(String userId, String operateUid) {
        ...
        try {
            ...
            if (persons != null && persons.size() > 0) {
                ...
                List<Map<String, Object>> goods = goodsService.queryPersonProducts(userId, 1, 9999);
     ...
     * @return
     */
    @RequestMapping(value = "qAnchorInfo")
    @ResponseBody
    public Map<String, Object> qAnchorInfo(@RequestParam(required = true) String userId) {
        Map<String, Object> obj = new HashMap<String, Object>();
        try {
