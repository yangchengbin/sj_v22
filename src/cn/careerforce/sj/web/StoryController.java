    ...
    public Map<String, Object> queryStoryById(String id, String userId) {
        ...
        try {
            ...
            if (!"".equals(description)) {
                ...
                StringBuffer sb = new StringBuffer("<html><head><style type='text/css'>body{padding:0;margin:0;}p{margin-bottom:10px;color:#585858;text-align:left;font-size:12px;line-height:24px;text-indent:2em;padding:6px 10px;}img{width:100%;margin-top:6px;}</style></head><body id='body'>");
